// an approach that calculate sum each time but for the same cell multiply by its appearance times to save some effort
public class Excel {
    Cell[][] table;
...
// a very optimized approach that remember each cell's value and update all the cells if needed:
// https://leetcode.com/problems/design-excel-sum-formula/discuss/104880/C++-3-ms-concise-and-easy-to-understand

// a naive approach: calculate each cell everytime, even though the cell has appeared multiple times by in a sum
// https://leetcode.com/problems/design-excel-sum-formula/discuss/104866/A-different-solution-in-Java-Beats-80
